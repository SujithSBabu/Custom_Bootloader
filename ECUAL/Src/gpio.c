...
/*GPIO-BUTTON user config. */
GPIO_Hanlde_Struct gpio_button_user_cfg[] = {
		{.gpio_cfg = {.gpio_pin = GPIO_PIN_5, .gpio_pin_mode = GPIO_INPUT_MODE, .gpio_pin_speed = GPIO_HIGH_SPEED, .gpio_pin_pupd = GPIO_PIN_PU}, .gpio_reg_def = GPIOB}
};
